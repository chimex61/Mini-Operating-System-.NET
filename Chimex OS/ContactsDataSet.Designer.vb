...
Partial Public Class ContactsDataSet
    ...
    Partial Public Class DataDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddDataRow(ByVal NAME As String, ByVal ADDRESS As String, ByVal GENDER As String, ByVal PHONE As String, ByVal EMAIL As String) As DataRow
            Dim rowDataRow As DataRow = CType(Me.NewRow,DataRow)
            Dim columnValuesArray() As Object = New Object() {NAME, ADDRESS, GENDER, PHONE, EMAIL}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByNAME(ByVal NAME As String) As DataRow
            Return CType(Me.Rows.Find(New Object() {NAME}),DataRow)
        End Function
    ...
    Partial Public Class DataRow
        ...
        Public Function IsPHONENull() As Boolean
            Return Me.IsNull(Me.tableData.PHONEColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetPHONENull()
            Me(Me.tableData.PHONEColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function IsEMAILNull() As Boolean
            Return Me.IsNull(Me.tableData.EMAILColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetEMAILNull()
            Me(Me.tableData.EMAILColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace ContactsDataSetTableAdapters
    ...
    Partial Public Class DataTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Data` WHERE ((`NAME` = ?) AND ((? = 1 AND `ADDRESS` IS NULL) OR (`AD"& _ 
                "DRESS` = ?)) AND ((? = 1 AND `GENDER` IS NULL) OR (`GENDER` = ?)) AND ((? = 1 AN"& _ 
                "D `PHONE` IS NULL) OR (`PHONE` = ?)) AND ((? = 1 AND `EMAIL` IS NULL) OR (`EMAIL"& _ 
                "` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Data` (`NAME`, `ADDRESS`, `GENDER`, `PHONE`, `EMAIL`) VALUES (?, ?, "& _ 
                "?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Data` SET `NAME` = ?, `ADDRESS` = ?, `GENDER` = ?, `PHONE` = ?, `EMAIL` ="& _ 
                " ? WHERE ((`NAME` = ?) AND ((? = 1 AND `ADDRESS` IS NULL) OR (`ADDRESS` = ?)) AN"& _ 
                "D ((? = 1 AND `GENDER` IS NULL) OR (`GENDER` = ?)) AND ((? = 1 AND `PHONE` IS NU"& _ 
                "LL) OR (`PHONE` = ?)) AND ((? = 1 AND `EMAIL` IS NULL) OR (`EMAIL` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Chimex_OS.My.MySettings.Default.ContactsConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT NAME, ADDRESS, GENDER, PHONE, EMAIL FROM Data"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As ContactsDataSet.DataDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As ContactsDataSet.DataDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As ContactsDataSet.DataDataTable = New ContactsDataSet.DataDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As ContactsDataSet.DataDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_NAME As String, ByVal Original_ADDRESS As String, ByVal Original_GENDER As String, ByVal Original_PHONE As String, ByVal Original_EMAIL As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal NAME As String, ByVal ADDRESS As String, ByVal GENDER As String, ByVal PHONE As String, ByVal EMAIL As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal NAME As String, ByVal ADDRESS As String, ByVal GENDER As String, ByVal PHONE As String, ByVal EMAIL As String, ByVal Original_NAME As String, ByVal Original_ADDRESS As String, ByVal Original_GENDER As String, ByVal Original_PHONE As String, ByVal Original_EMAIL As String) As Integer
            If (NAME Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal ADDRESS As String, ByVal GENDER As String, ByVal PHONE As String, ByVal EMAIL As String, ByVal Original_NAME As String, ByVal Original_ADDRESS As String, ByVal Original_GENDER As String, ByVal Original_PHONE As String, ByVal Original_EMAIL As String) As Integer
            Return Me.Update(Original_NAME, ADDRESS, GENDER, PHONE, EMAIL, Original_NAME, Original_ADDRESS, Original_GENDER, Original_PHONE, Original_EMAIL)
        End Function
    End Class
